...
Arrow size, cap/compound/alignment/join editing, generic/advanced effects, custom shadow transforms, non-shape shadow APIs, custom-geometry connections/text rectangles/evaluation, shape-text creation options, advanced line fill/custom dash creation, and percentage positions remain pending.
