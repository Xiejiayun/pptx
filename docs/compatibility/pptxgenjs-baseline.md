...
| table/table-cell `align: left/center/right/justify` | `AddTableOptions.align` / `AddTableCellOptions.align` | 已支持 table/cell 单段落创建、cell precedence 与 PptxGenJS final-state 对等；已有 cell snapshot/editor 尚未支持 |
