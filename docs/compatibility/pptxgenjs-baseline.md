...
| `slide.addTable()` string / cell-object rows + name/x/y/w/h/colW/rowH/align/border/fill/margin/valign | `slide.addTable(rows, options)` | 部分支持：strict rectangular single-paragraph strings、`{ text, options?: { align, border, fill, margin, valign } }` objects、table/cell align/border/fill/margin/valign、direct paragraph align 与 cell border/fill/margin/valign、EMU geometry、创建时 scalar/per-axis sizes |
