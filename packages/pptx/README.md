...
The locked PptxGenJS 4.0.1 public capability list is now 100% covered. Final full-parity certification still waits for the actual-package, browser, client, and peer audit; it is not claimed early here.
