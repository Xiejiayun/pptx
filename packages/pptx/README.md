...
Overall PptxGenJS parity remains approximately 97%. The next item is table-cell hyperlink creation, followed by rich/multi-paragraph cell text and style, merge/colspan/rowspan, row/column CRUD, auto-page/repeated headers, `tableToSlides`, and the final peer/client audit.
