...
External SVG relationships, SVG DOM-level editing, image hyperlinks, advanced placeholder styling, and public per-image deletion/media garbage collection remain pending. Embedded media creation is documented next.
...
The declaration-atom matrix now closes 1,740/1,774 entries (98.08%), with 34 remaining: 757 supported, 518 deliberate differences, 94 deprecated aliases, and 371 defect exclusions; unsupported, stale, and diagnostics are all zero. The latest six-atom Hyperlink Owners family directly supports URL, one-based slide, tooltip, shape, and image ownership. Rich-text outer hyperlink remains a deliberate difference because native output preserves legal whole-shape/run relationship ownership instead of copying PptxGenJS 4.0.1 dangling `rIdundefined` output. Raster and SVG images now expose strict create, edit, duplicate, rollback, package, browser, and reopen hyperlink behavior.

The fresh 66-entry actual tarball is 726,424 bytes with SHA-256 `cf8ff70e932f11b2fe830d06d33cd4edae7a3fc50fbe127498a2ddd7757b22f1`. Its Node and persistent-browser evidence decks are both 24,776 bytes with 26 parts, 31 relationships, four slides, and four shapes; their SHA-256 values are `bc774ec41fa69707a5403bfff3af3dc968de90c3cb9f52358aa65631bb284052` and `addb86cf1e7e0559d449b1eceba54e6289bcae34c2a7a1d9e0d5301fa9764588`. All 26 decompressed parts are byte-identical. Installed Node/CLI, the browser build, owner-bound OOXML, and PowerPoint 2010 validation pass with zero errors and one expected external-link warning. Async image-source target moves, target/owner delete-and-same-URI replacement, and invalid pre-I/O rejection also pass.
