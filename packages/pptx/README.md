...
The declaration-atom matrix now closes 1,734/1,774 entries (97.75%), with 40 remaining: 752 supported, 517 deliberate differences, 94 deprecated aliases, and 371 defect exclusions; unsupported, stale, and diagnostics are all zero. The latest 14-atom Core Content & Primitive Inputs family directly supports five plain-string, percentage-coordinate, and scalar-margin cases. Nine flat rich-text, recursive table-cell, permissive-color, implicit-inch, and structured-option inputs are explicit projections onto strict paragraph/run, sRGB/scheme-color, EMU/`inches()`, and documented TRBL native state rather than copied input shapes.

The fresh 66-entry actual tarball is 724,878 bytes with SHA-256 `e44030f6b4c0b2f55a5afa0ce14e5a92fda505ffb25cb946120bd7d9bc5afb01`. Its Node and persistent Chrome 150 evidence decks are both 23,317 bytes with 20 parts, 17 relationships, two slides, four shapes, and no external relationships; their SHA-256 values are `292eb8ecdb7e8c7309c5386a96458ae83b876ea15d9ca052f36f47ad5f9aeb78` and `f7a32f31af68d9a51f6f1e39cc6ad32860ae0d2636f8147cf7a28ce59f4c5674`. All 20 decompressed parts are byte-identical. Installed Node/CLI, persistent Chrome, owner-bound OOXML, and PowerPoint 2010 validation pass with zero errors and zero warnings. PptxGenJS writes `[1,2,3,4]` margins as TRBL `4/2/3/1`; native deliberately retains the documented `1/2/3/4` order.
