...
Overall PptxGenJS parity remains approximately 97%. The next item is table-level direct fill consensus read/bulk edit, followed by table-level border, the remaining advanced text/table work, `tableToSlides`, and the final peer/client audit.
