...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@pptx/model/internal/chart-create': `${root}packages/model/src/chart-create.internal.ts`,
      '@pptx/model/internal/shape-hyperlink': `${root}packages/model/src/shape-hyperlink.internal.ts`,
